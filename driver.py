...
file1=open('data.csv','w',encoding='utf-8',newline='')
...
file2=open('product.csv','w',encoding='utf-8',newline='')
...
def main():
    ...
    # #Scrape 14 webpage search results
    for i in range(1,15):
    ...
    fil=open('data.csv','r',encoding='utf-8')
